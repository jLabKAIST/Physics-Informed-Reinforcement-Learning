...
if __name__== '__main__':
    ...
    if args.network=='DQN' or args.network=='Double':
        ...
        q.load_state_dict(torch.load('July5_256_7man_1100_70_0.00150431_0.00243219_stateDict.pt',map_location=device))
        q_target.load_state_dict(torch.load('July5_256_7man_1100_70_0.00150431_0.00243219_stateDict.pt',map_location=device))
