...
if __name__== '__main__':
    ...
    if args.network=='FCN_notrain' or args.network=='Double':
        ...
        q.load_state_dict(torch.load(f'{CURR_DIR}/UNet/Sep5_scaled_256_2man_1100_70_0.01049114_0.02165910_stateDict.pt',map_location=device))
        q_target.load_state_dict(torch.load(f'{CURR_DIR}/UNet/Sep5_scaled_256_2man_1100_70_0.01049114_0.02165910_stateDict.pt',map_location=device))
